...
ExecInitNode(Plan *node, EState *estate, int eflags)
{
	...
	switch (nodeTag(node))
	{
		...
		case T_Gather:
			...
			break;
		case T_Balance:
			result = (PlanState *) ExecInitBalance((Balance *) node, estate, eflags);
			break;
		case T_Mirror:
			result = (PlanState *) ExecInitMirror((Mirror *) node, estate, eflags);
			break;
		// PargreSQL}
...
ExecProcNode(PlanState *node)
{
	...
	switch (nodeTag(node))
	{
		...
		case T_GatherState:
			...
			break;
		case T_BalanceState:
			result = ExecBalance((BalanceState *) node);
			break;
		case T_MirrorState:
			result = ExecMirror((MirrorState *) node);
			break;
		// PargreSQL}
...
ExecCountSlotsNode(Plan *node)
{
	...
	switch (nodeTag(node))
	{
		...
		case T_Balance:
			return ExecCountSlotsBalance((Balance *) node);
		case T_Mirror:
			return ExecCountSlotsMirror((Mirror *) node);
		// PargreSQL}
